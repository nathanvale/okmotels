...
- [gatsby-starter-gcn](#gatsby-starter-gcn)
  - [Features](#features)
  - [Demo](#demo)
  - [Getting Started](#getting-started)
    - [Install](#install)
    - [Setup Contentful](#setup-contentful)
  - [Customization](#customization)
    - [Website Data](#website-data)
    - [Theme](#theme)
    - [Using Gatsby Standard](#using-gatsby-standard)
    - [Content and SEO](#content-and-seo)
  - [Deployment](#deployment)
    - [Manual Netlify Deployment](#manual-netlify-deployment)
    - [Netlify Deployment From Git (Recommended)](#netlify-deployment-from-git-recommended)
  - [Additional Settings](#additional-settings)
    - [Contentful Webhook (Optional)](#contentful-webhook-optional)
    - [Netlify Form Notifications (Optional)](#netlify-form-notifications-optional)
